...
import sugar.free.telesto.exceptions.IncompatibleSatlVersionException;
import sugar.free.telesto.exceptions.InvalidMacTrailerException;
import sugar.free.telesto.exceptions.InvalidNonceException;
import sugar.free.telesto.exceptions.InvalidPacketLengthsException;
import sugar.free.telesto.exceptions.InvalidPreambleException;
import sugar.free.telesto.exceptions.InvalidSatlCRCException;
import sugar.free.telesto.exceptions.InvalidSatlCommandException;
import sugar.free.telesto.parser.ids.SatlCommandIDs;
...
public abstract class SatlMessage {
    ...
    public ByteBuf serialize(Class<? extends SatlMessage> clazz, byte[] key) {
        ...
        else byteBuf = serializeCTR(nonce.getProductionalBytes(), key, SatlCommandIDs.IDS.getB(clazz));
    ...
    private ByteBuf serializeCRC(Class<? extends SatlMessage> clazz) {
        ...
        byteBuf.putByte(SatlCommandIDs.IDS.getB(clazz));
        ...
        Log.d("SatlMessage", "Serializing: " + Hex.toHexString(byteBuf.getBytes()));
        return byteBuf;
    }
    ...
    private ByteBuf serializeCTR(ByteBuf nonce, byte[] key, byte commandId) {
        ...
        Log.d("SatlMessage", "Serializing: " + Hex.toHexString(byteBuf.getBytes()));
        Log.d("SatlMessage", "Unencrypted payload: " + Hex.toHexString(data.getBytes()));
        return byteBuf;
    }
    ...
    private static SatlMessage deserializeCTR(ByteBuf data, Nonce lastNonce, byte[] key) throws InvalidMacTrailerException, InvalidNonceException, InvalidPreambleException, InvalidPacketLengthsException, IncompatibleSatlVersionException, InvalidSatlCommandException {
        Log.d("SatlMessage", "Deserializing: " + Hex.toHexString(data.getBytes()));
        ...
        Class<? extends SatlMessage> clazz = SatlCommandIDs.IDS.getA(commandId);
        ...
        Log.d("SatlMessage", "Decrypted payload: " + Hex.toHexString(payload));
