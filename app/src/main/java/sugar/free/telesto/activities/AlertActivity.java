...
public class AlertActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TelestoApp.getAlertService().setAlertActivity(this);
        Alert alert = TelestoApp.getAlertService().getAlert();
    ...
    protected void onDestroy() {
        super.onDestroy();
        TelestoApp.getAlertService().setAlertActivity(null);
    }
    ...
    public void muteClicked(View view) {
        ...
        new Thread(() -> {
            try {
                MessageRequestUtil.snoozeAlert(alert.getAlertId());
            } catch (Exception e) {
                ExceptionTranslator.makeToast(AlertActivity.this, e);
            }
        }).start();
    }
    ...
    public void confirmClicked(View view) {
        ...
        new Thread(() -> {
            try {
                MessageRequestUtil.confirmAlert(alert.getAlertId());
            } catch (Exception e) {
                ExceptionTranslator.makeToast(AlertActivity.this, e);
            }
        }).start();
